/**
 * The Garmin Connect endpoint catalogue soma's ingest walks: daily, range, activity-detail and discovery
 * requests, and how to build one for a date or an activity. Pure.
 */
/**
