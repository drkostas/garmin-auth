/**
 * Parsers for the daily-health, weight, sleep, HRV and training-readiness payloads Garmin Connect returns,
 * into flat rows. Pure; storing them is the consumer's.
 */
/**
